...
module.exports.run = async (client, interaction) => {
  ...
  const countryDimensions = await getCountryDimensions(
    countryName.toLowerCase().replace(/ /g, '_'),
    worldMapSvg
  );
  ...
  const svg = await loadImage(
    `assets/img/countrySvg/${countryName.replace(/ /g, '')}.svg`
  );
  ...
  const canvasBuffer = await createCanvasImage(
    imageBuffer,
    streetviewImageProps.width,
    streetviewImageProps.height
  );
  ...
  ctx.lineTo(
    streetviewImageProps.offset.x + streetviewImageProps.width - 50,
    streetviewImageProps.offset.y
  );
  ctx.quadraticCurveTo(
    streetviewImageProps.offset.x + streetviewImageProps.width,
    streetviewImageProps.offset.y,
    streetviewImageProps.offset.x + streetviewImageProps.width,
    streetviewImageProps.offset.y + 50
  );
  ctx.lineTo(
    streetviewImageProps.offset.x + streetviewImageProps.width,
    streetviewImageProps.offset.y + streetviewImageProps.height - 50
  );
  ctx.quadraticCurveTo(
    streetviewImageProps.offset.x + streetviewImageProps.width,
    streetviewImageProps.offset.y + streetviewImageProps.height,
    streetviewImageProps.offset.x + streetviewImageProps.width - 50,
    streetviewImageProps.offset.y + streetviewImageProps.height
  );
  ctx.lineTo(
    streetviewImageProps.offset.x + 50,
    streetviewImageProps.offset.y + streetviewImageProps.height
  );
  ctx.quadraticCurveTo(
    streetviewImageProps.offset.x,
    streetviewImageProps.offset.y + streetviewImageProps.height,
    streetviewImageProps.offset.x,
    streetviewImageProps.offset.y + streetviewImageProps.height - 50
  );
  ...
  const maxRightSvg =
    (countryDimensions.offset.x + countryDimensions.width) /
    worldMapDimensions.width;
  const maxBottomSvg =
    (countryDimensions.offset.y + countryDimensions.height) /
    worldMapDimensions.height;
  ...
  const horizontalDifference =
    -(maxRightSvg - maxLeftSvg) + (maxRightActualMap - maxLeftActualMap);
  const verticalDifference =
    maxBottomSvg - maxTopSvg - (maxBottomActualMap - maxTopActualMap);
  ...
  ctx.arc(
    x + svg.width * lngRatio,
    y + svg.height * (1 - latRatio),
    circleRadius.background * 2,
    0,
    Math.PI * 2,
    true
  );
  ...
  ctx.drawImage(
    virtualstreetsIcon.data,
    virtualstreetsIcon.offset.x,
    virtualstreetsIcon.offset.y,
    virtualstreetsIcon.width,
    virtualstreetsIcon.height
  );
  ...
  ctx.fillText(
    virtualstreetsName.data,
    virtualstreetsName.offset.x,
    virtualstreetsName.offset.y
  );
