module.exports = (ctx, imageProps) => {
  ...
  ctx.quadraticCurveTo(
    imageProps.offset.x + imageProps.width,
    imageProps.offset.y,
    imageProps.offset.x + imageProps.width,
    imageProps.offset.y + 50
  );
  ctx.lineTo(
    imageProps.offset.x + imageProps.width,
    imageProps.offset.y + imageProps.height - 50
  );
  ctx.quadraticCurveTo(
    imageProps.offset.x + imageProps.width,
    imageProps.offset.y + imageProps.height,
    imageProps.offset.x + imageProps.width - 50,
    imageProps.offset.y + imageProps.height
  );
